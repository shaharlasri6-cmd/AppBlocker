...
cp "$ROOT/android/app/build/outputs/apk/debug/app-debug.apk" "$ROOT/release/AppBlocker-v1.3.0-debug.apk"
echo ""
echo "APK ready: $ROOT/release/AppBlocker-v1.3.0-debug.apk"
