...
cp "$ROOT/android/app/build/outputs/apk/debug/app-debug.apk" "$ROOT/release/AppBlocker-v2.0.1-debug.apk"
echo ""
echo "APK ready: $ROOT/release/AppBlocker-v2.0.1-debug.apk"
